...
export default function Nam002Location() {
  const frameRef = useRef<HTMLDivElement>(null);
  const isInView = useInView(frameRef, { amount: 0.35, once: true });

  return (
    <section id="nam002-location-section">
      {/* Flower Two */}
      <motion.div
        className="nam002-location-flower-two"
      ...
      {/* Star Two */}
      <motion.div
        className="nam002-location-star-two"
      ...
      <div className="nam002-location-container">
        <div className="nam002-location-content">
          {/* Near left side flower: blooms right as flip settles, in sync with title */}
          <motion.div
            className="nam002-location-flower-one"
            initial={{ opacity: 0, scale: 0.7 }}
            animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.7 }}
          ...
          <motion.div
            className="nam002-location-star-one"
          ...
          {/* 1. Title */}
          <motion.h2
            className="nam002-location-title"
          ...
          <motion.p
            className="nam002-location-description"
            initial={{ opacity: 0, y: 25 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 25 }}
          ...
          <motion.a
            ...
            className="nam002-location-button cursor-pointer no-underline text-white"
            initial={{ opacity: 0, y: 25 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 25 }}
        ...
        <div className="nam002-location-design">
          ...
          <div className="nam002-location-frame" ref={frameRef}>
            ...
            <motion.img
              alt=""
              className="nam002-location-photo"
